			...
			<div class="navigation">
			 <span class="menu"></span> 
				...
				<li><a href="javascript:void(0);">首页</a></li>
						<li><a href="pshop">商品管理</a></li>
						<li><a href="ptype">类型管理</a></li>
						<li><a href="puser">用户管理</a></li>
						<li><a href="porder">订单管理</a></li>
						<li><a href="pnotice">公告管理</a></li>
...
<div class="welcome">
	<div class="container">
		<h4>欢迎
			...
			<p id="content">
			<c:if test="${bruser!=null}"><font color="black"> ${auser.aname} </font></c:if>
			</p>
			登陆水果沙拉平台</h4>
