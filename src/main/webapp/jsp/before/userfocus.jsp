		...
		<div>
			<div class="nFlowBox">
				<table width="99%" align="center" border="0" cellpadding="5"
					...
					<tr>
						<th><font style="color: black;">商品编号</font></th>
						<th><font style="color: black;">商品名称</font></th>
						<th><font style="color: black;">商品图片</font></th>
						<th><font style="color: black;">商品价格</font></th>
						<th><font style="color: black;">去看看</font></th>
					</tr>
					<tr>
						<td colspan="5" height="15px"
							style="border: 0 none; background: "></td>
					</tr> 
					<c:forEach var="mf" items="${myFocus}"> 
						<tr>
							<td bgcolor="" align="center"><font style="color: black;">${mf.id}</font></td>
							<td bgcolor=""  align="center"><font style="color: black;">${mf.gname}</font></td>
							<td align="center" bgcolor="" height="60px"> <img
									style="width: 50px; height: 50px;"
									src="logos/${mf.gpicture}" border="0"
									title="${mf.gname}" /> </td>
							<td align="center" bgcolor=""><font style="color: black;">${mf.grprice}</font></td>
							<td align="center" bgcolor="">
								<a style="text-decoration: none;" class="f6" href="goodsDetail?id=${mf.id}"><font style="color: black;">去看看</font></a>
							</td>
						</tr>
					</c:forEach>
				</table>
